...
Hood.create!(name: "Jules", city: "Bordeaux", description: "Combattant de rue", skills: "Bucheron", price: 500, rating: 4, violence_range: 1, url:"https://images.unsplash.com/photo-1544121505-740398defbcb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
...
Hood.create!(name: "Florian", city: "Bordeaux", description: "Aïe ça fait mal !", skills: "nunchaku", price: 400, rating: 3, violence_range: 2, url:"https://images.unsplash.com/photo-1583139927896-012a0534cfe9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
Hood.create!(name: "Nico", city: "Bordeaux", description: "Il/elle aura les oreilles en sang 👍", skills: "pichnette de pro", price: 100, rating: 5, violence_range: 1, url:"https://images.unsplash.com/photo-1567159170218-1abf6457cc27?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
Hood.create!(name: "Julien", city: "Bordeaux", description: "Je giffle comme personne, tu verras 😉", skills: "Slap world champion", price: 800, rating: 3, violence_range: 2, url:"https://images.unsplash.com/photo-1551930139-1deb64d83adc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
...
Hood.create!(name: "Valentine", city: "Bordeaux", description: "Chaud en arts martiaux", skills: "CPE", price: 400, rating: 4, violence_range: 1, url:"https://images.unsplash.com/photo-1541727261696-8680e53c1149?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
Hood.create!(name: "Benoit", city: "Bordeaux", description: "Chaud en arts martiaux", skills: "Doublure de Wolverine", price: 200, rating: 3, violence_range: 2, url:"https://images.unsplash.com/photo-1552263354-65bc69113887?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
